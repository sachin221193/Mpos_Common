package com.vestige.common.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling {
    ...
    public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
        ...
        if (problem instanceof ConstraintViolationProblem) {
            builder
                .with(ErrorConstants.VIOLATIONS, ((ConstraintViolationProblem) problem).getViolations())
    ...
    public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, @Nonnull NativeWebRequest request) {
        ...
        Problem problem = Problem.builder()
            ...
            .withTitle(ErrorConstants.METHOD_ARGUMENT_NOT_VALID)
            .withStatus(defaultConstraintViolationStatus())
            .with(ErrorConstants.MESSAGE, ErrorConstants.ERR_VALIDATION)
            .with(ErrorConstants.FIELD_ERRORS, fieldErrors)
            .build();
    ...
    public ResponseEntity<Problem> handleNoSuchElementException(NoSuchElementException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
            ...
            .with(ErrorConstants.MESSAGE, ErrorConstants.ENTITY_NOT_FOUND_TYPE)
            .build();
        return create(ex, problem, request);
    }
	...
	public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex,
		...
		Problem problem = Problem.builder().withStatus(ex.getStatus())
				.with(ErrorConstants.MESSAGE, ErrorConstants.ERR_VALIDATION).withTitle(ex.getMessage()).build();
    ...
    public ResponseEntity<Problem> handleConcurrencyFailure(ConcurrencyFailureException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
            ...
            .with(ErrorConstants.MESSAGE, ErrorConstants.ERR_CONCURRENCY_FAILURE)
            .build();
        return create(ex, problem, request);
    }
    
    /**this is called from REST Template Error for 4xx
     * Th
	...
	public ResponseEntity<Problem> handleHttpClientErrorException(HttpClientErrorException clientException,
		...
		Problem problem = Problem.builder().withStatus(HttpStatusAdapter.get4xStatus(clientException.getStatusCode()))
